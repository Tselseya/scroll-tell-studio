...
> I agree to the [Terms of Service](/terms) and acknowledge the [Privacy Policy](/privacy). I understand that M.O.S.A.N.G. will process my account information to create and secure my account and provide the service.
...
> Allow optional analytics to help us understand aggregate product usage and improve M.O.S.A.N.G.. This is optional, is not required to use the service, and can be withdrawn from Privacy choices.
...
> I authorize M.O.S.A.N.G. to connect to the selected platform using the permissions shown on the authorization screen. I understand what actions M.O.S.A.N.G. may take, that the platform’s terms and policies also apply, and that I can disconnect the account. M.O.S.A.N.G. will use the platform’s approved API flow where available.
...
This confirmation should be recorded with the content variant, destination, account, payload hash, user, time, policy version, and job identifier. Confirmation does not transfer responsibility for rights clearance or platform compliance to M.O.S.A.N.G..
